package edu.shtanko.unarea.app.weeks.week_a;
...
import edu.shtanko.unarea.app.days_week_a.*;
...
public class WeekA extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_week_a);
        ...
        String of = " of the week A";
        hm.put(WEEK_DAY, monday);
        hm.put(DAY_OF_A_WEEK, monday + of);
        hm.put(IMAGE_WEEK, R.drawable.monday_a_icon);
        ...
        hm.put(IMAGE_WEEK, R.drawable.thursday_a_icon);
        ...
        hm.put(IMAGE_WEEK, R.drawable.wednesday_a_icon);
        ...
        hm.put(IMAGE_WEEK, R.drawable.friday_a_icon);
