...
public class Parser extends Activity {
    ...
    public static String TAG_WEEK;
    public static String TAG_DAY;
    ...
    private class ParseJSONTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            String jsonUrl = webService.getJSONData("https://json-parser-android.googlecode.com/git/json/timetable.json");

            try {
                JSONObject jsonObject = new JSONObject(jsonUrl);

                JSONObject weekaJSONObject = jsonObject.getJSONObject(TAG_WEEK);
                JSONObject mondayJSONObject = weekaJSONObject.getJSONObject(TAG_DAY);
                JSONArray jsonArray = mondayJSONObject.getJSONArray(TAG);
