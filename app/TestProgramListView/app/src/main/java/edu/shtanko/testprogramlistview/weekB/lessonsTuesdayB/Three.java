package edu.shtanko.testprogramlistview.weekB.lessonsTuesdayB;
...
public class Three extends Activity {
    ...
    private static final String TAG_MONDAY = "2";
    ...
    private class ParseJSONTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                JSONArray jsonArray = mondayJSONObject.getJSONArray(TAG_3);
