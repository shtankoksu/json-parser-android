...
import edu.shtanko.testprogramlistview.daysWeekA.*;
import edu.shtanko.testprogramlistview.app.R;

import java.util.ArrayList;
import java.util.HashMap;

public class WeekA extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.week_a);
        ...
        hm.put(DAY_OF_A_WEEK, "Monday of the week A");
        hm.put(IMAGE_WEEK, R.drawable.monday144);

        weeks.add(hm);

        hm = new HashMap<String, Object>();
        hm.put(WEEK_DAY, "Tuesday");
        hm.put(DAY_OF_A_WEEK, "Tuesday of the week A");
        hm.put(IMAGE_WEEK, R.drawable.tuesday144);

        weeks.add(hm);

        hm = new HashMap<String, Object>();
        hm.put(WEEK_DAY, "Wednesday");
        hm.put(DAY_OF_A_WEEK, "Wednesday of the week A");
        hm.put(IMAGE_WEEK, R.drawable.wednesday144);

        weeks.add(hm);

        hm = new HashMap<String, Object>();
        hm.put(WEEK_DAY, "Thursday");
        hm.put(DAY_OF_A_WEEK, "Thursday of the week A");
        hm.put(IMAGE_WEEK, R.drawable.thursday144);

        weeks.add(hm);

        hm = new HashMap<String, Object>();
        hm.put(WEEK_DAY, "Friday");
        hm.put(DAY_OF_A_WEEK, "Friday of the week A");
        hm.put(IMAGE_WEEK, R.drawable.friday144);
