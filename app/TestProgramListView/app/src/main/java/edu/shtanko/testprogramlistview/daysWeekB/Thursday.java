package edu.shtanko.testprogramlistview.daysWeekB;
...
import edu.shtanko.testprogramlistview.weekB.lessonsThursdayB.*;

public class Thursday extends TabActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_thurstday);
